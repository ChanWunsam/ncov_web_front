...
export default {
  ...
  methods: {
    ...
    //         //更新加查询
    //         this.axios
    //           .post("/api/count/insert", qs.stringify(params_count))
    //           .then(res => {
    ...
    //                   this.$refs["case" + i][0].validate(valid => {
    //                     if (valid) count++;
    //                   });
    //                 }
    //                 if (count == this.cases.length) {
    //                   var params = [];
    //                   for (let i = 0; i < this.cases.length; i++) {
    //                     params.push({
